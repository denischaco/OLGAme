...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: WyDzkyOl6Pq4/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: v_kC1eoHoKoW/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__q5CFs)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__fbA29)}
              />
            </React.Fragment>
          ),
          value: args.children
